...
//            System.out.println("Response Code : " + responseCode);
    ...
    public static JsonNode getGooglePeople(String accessToken) { // 31. 파라미터로 컨트롤러에서 넘어온 accessToken을 받아온다.
...
//            System.out.println("Response Code : " + responseCode);
            ...
            // 37. JSON 형태의 데이터를 파싱하기 위한 ObjectMapper를 생성한다.
            ...
            ObjectMapper mapper = new ObjectMapper();
            // 38. 36에서 받아온 JSON 형태의 반환 값을 35에서 미리 만들어둔 변수에 해당 타입인 JsonNode 객체로 파싱하여 전달한다.
            returnNode = mapper.readTree(response.getEntity().getContent());
